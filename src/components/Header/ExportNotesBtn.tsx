...
const ExportNotesBtn = () => {
  ...
  const onExport = async (e: React.MouseEvent, fileExtension: IWorkerFIleExt['fileExtension']) => {
    try {
      ...
      worker.onmessage = function (e) {
        ...
        let blob = new Blob([data.content], { type: FILE_TYPES[fileExtension] })
  ...
  return (
    ...
    >
      ...
      >
        <span>Export Data As</span> <img src={exportNotesImg} alt="export data button" />
      </summary>
